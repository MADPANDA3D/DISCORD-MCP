...
class AccessControlTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_build_app_keeps_health_public_and_mcp_authenticated(self):
        ...
        self.assertEqual(health["raw_tool_count"], 56)
        self.assertEqual(health["exposed_tool_count"], 56)
        self.assertEqual(health["agent_ready_tool_count"], 50)
        self.assertEqual(health["documented_tool_count"], 56)

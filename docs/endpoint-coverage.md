...
| Messages, native polls, reactions, pins, and bulk moderation | Covered | channel history and poll state, guild search, message, reactions, current paginated pins | native poll creation, crosspost, typing, pin/unpin, clear reactions, bulk delete | Polls support 2-10 answers, 1-768 hours, and optional multiselect; dedicated message tools remain preferred for ordinary sends/edits/deletes. |

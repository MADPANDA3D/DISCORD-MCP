...
| Message attachment CDN plus configured vision endpoint | GET, POST | Provider extension | `analyze_attachment` | Image OCR/description only; requires explicit OpenAI vision setup. |

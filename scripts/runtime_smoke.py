...
EXPECTED_TOOL_COUNT = int(os.getenv("MCP_EXPECTED_TOOL_COUNT", "56"))
EXPECTED_AGENT_READY_COUNT = int(os.getenv("MCP_EXPECTED_AGENT_READY_COUNT", "50"))
...
EXPECTED_CATALOG_VERSION = os.getenv("MCP_EXPECTED_CATALOG_VERSION", "discord-2026.08.31.2")

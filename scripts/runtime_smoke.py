...
EXPECTED_AGENT_READY_COUNT = int(os.getenv("MCP_EXPECTED_AGENT_READY_COUNT", "49"))
...
EXPECTED_CATALOG_VERSION = os.getenv("MCP_EXPECTED_CATALOG_VERSION", "discord-2026.08.27.1")

#!/usr/bin/env python3
"""Fail CI when public source crosses the private operator boundary."""
...
TEXT_RULES = {
    ...
    "production service domain": re.compile(r"\bdiscord-mcp\.madpanda3d\.com\b", re.I),
    "private Portal URL": re.compile(
        r"\bmadpanda3d\.com/lab/mad-mcps/portal(?:/|\b)",
        re.I,
    ),
}

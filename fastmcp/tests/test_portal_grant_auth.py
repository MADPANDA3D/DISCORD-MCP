...
class PortalGrantAuthTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_build_app_wraps_mcp_and_keeps_health_public(self):
        ...
        self.assertEqual(health["raw_tool_count"], 52)
        self.assertEqual(health["exposed_tool_count"], 52)
        self.assertEqual(health["agent_ready_tool_count"], 46)
        self.assertEqual(health["documented_tool_count"], 52)
